...
function FeaturedCard({ blog }: { blog: Blog }) {
  return (
    <Link
      href={`/blog/${blog.id}`}
      className="group block relative rounded-2xl overflow-hidden shadow-lg aspect-[16/9]"
    >
      {blog.image && (
        <Image
          src={blog.image}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-br from-purple-900 via-purple-700 to-purple-500 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 pt-16 pb-12 text-center">
          ...
          <p className="text-purple-200 text-sm sm:text-base max-w-md mx-auto">
            Practical advice on keeping Nigerian homes clean, pest-free, and
            healthy — from the experts at AskTouch.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        {!hasMore && blogs.length > 0 && (
          <p className="text-center text-gray-400 mt-8 text-xs tracking-wide">
