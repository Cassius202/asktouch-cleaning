...
// Fetch blogs with proper pagination using cursor (more efficient than OFFSET)
export async function fetchBlogs(cursor?: string) {
  ...
  try {
    ...
    // If cursor provided, get blogs older than the cursor date
    if (cursor) {
