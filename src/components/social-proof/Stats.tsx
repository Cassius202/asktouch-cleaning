        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16 items-start">
          ...
          <FadeInView delay={0.2}>
            <p className="text-gray-500 text-lg md:text-xl lg:pt-4">
              Ask Touch clients are serious about their spaces. They’ve built
              beautiful homes and offices, and they want them preserved. These
              are the results we deliver every single day across Nigeria.
            </p>
          </FadeInView>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 lg:col-span-1 lg:row-span-2 bg-[#EEF2FF] rounded-[2.5rem] p-5 flex flex-col justify-between">
            <p className="text-xl xl:text-2xl font-medium text-gray-900 leading-relaxed italic">
              {` "They are a well trusted cleaning service company. They never disappoint you can trust them with your house and everything.
I have been working with them for a long time and they have always been reliable and efficient. They have a great reputation and I would recommend them to anyone looking for a reliable cleaning service."`}
            </p>
            <div className="mt-12">
              <p className="font-bold text-gray-900">Adebisi Henry</p>
              <p className="text-gray-500 text-sm">Google Verified Client</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-8">
              ...
              <p className="text-gray-500 text-sm">
                Consistent growth across Ibadan and Lagos.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F8FAFC] rounded-[2.5rem] p-8 flex flex-col justify-center">
            ...
            <p className="text-gray-500 text-sm">
              Every solution we use is safe for children, pets, and the
              environment.
            </p>
          </div>
          ...
          <div className="md:col-span-2 bg-[#F1F5F9] rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-500 text-sm max-w-xs mt-2">
                Average time our clients remain pest-free after a full
                deep-fumigation cycle.
              </p>
            </div>
